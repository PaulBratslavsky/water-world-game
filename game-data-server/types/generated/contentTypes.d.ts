...
export interface ApiBlockBlock extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['basic', 'nature', 'industrial', 'materials']
    > &
    ...
    height: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<1>;
...
export interface ApiPrefabPrefab extends Struct.CollectionTypeSchema {
  collectionName: 'prefabs';
  info: {
    displayName: 'Prefab';
    pluralName: 'prefabs';
    singularName: 'prefab';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    prefabId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::prefab.prefab': ApiPrefabPrefab;
